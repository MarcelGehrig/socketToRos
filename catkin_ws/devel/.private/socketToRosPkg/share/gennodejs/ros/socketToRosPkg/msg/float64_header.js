...
class float64_header {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new float64_header(null);
  ...
  static datatype() {
    ...
    return 'socketToRosPkg/float64_header';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new float64_header(null);
